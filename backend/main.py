...
# Crie uma lista chamada figurinhas com as 30 figurinhas.
# Apenas as figurinhas cujas imagens existem na pasta figurinhas/ devem ficar ativas.
# As figurinhas cujas imagens ainda não existem (ID 30) ficam comentadas.
figurinhas = [
    ...
    {"id": 30, "nome": "Spock", "categoria": "BRASIL", "imagem_url": "/figurinhas/30/imagem"},
]
...
# Crie o endpoint GET "/figurinhas/{id}/imagem"
